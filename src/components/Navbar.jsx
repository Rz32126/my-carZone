...
//     return (
//         <div>
//             <div className="navbar bg-blue-100 sticky top-0 z-10">
        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            >
              ...
              <li>
                <Link to="/available-car">Available Cars</Link>
              </li>
            </ul>
          </div>
          <a className="btn btn-ghost lg:text-xl text-blue-900 lg:font-bold">
            <span className="text-blue-600 lg:text-3xl lg:mr-4">
              <img className="w-12 h-12" src="https://i.ibb.co.com/qDDHcwC/Screenshot-2024-12-24-223953.png" />
            </span>
            <span className="hidden lg:block">CAR_RENT_ZONE</span>
          </a>
        </div>
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1 font-semibold text-blue-900">
        ...
        <div className="navbar-end">
          {user ? (
            <>
              <div>
                <ul className="lg:flex gap-3">
                  <li className="btn text-green-800 bg-blue-100">
                    <Link to="/add-car">Add Cars</Link>
                  </li>
                  <li className="btn text-green-800 bg-blue-100">
                    <Link to="/my-car">My Cars</Link>
                  </li>
                  <li className="btn text-green-800 bg-blue-100">
              ...
              <button onClick={handleLogOut} className="ml-4 mr-4 btn bg-red-300">
                Log out
              </button>
            </>
          ) : (
            <>
              <Link to="/login" className="mr-4 btn bg-lime-300">
                Login
              </Link>
            </>
          )}
