       ...
       <div>
           ...
           <div className="card bg-blue-200 border-blue-800 border">
              <div className="card-body">
                   <h2 className="card-title font-semibold text-blue-800"><span className="text-blue-900 text-2xl"><TbRelationManyToMany /></span>Wide Variety of Cars</h2>
                   <p>You Can choose your want one car according to your budget.You can Get here more luxury to cheapest car Here.</p>
            </div>
           </div> 
           <div className="card bg-blue-200  border-blue-800 border">
              <div className="card-body">
                   <h2 className="card-title font-semibold text-blue-800"><span className="text-green-700 text-2xl"><MdOutlinePriceCheck /></span>Affordable Prices</h2>
                   <p>If you want you can compare our price rate from other. The price is really budget friendly no tension!!!</p>
            </div>
           </div>
           <div className="card bg-blue-200  border-blue-800 border">
              <div className="card-body">
                   <h2 className="card-title font-semibold text-blue-800"><span className="text-rose-500 text-2xl"><TbBrandBooking /></span>Easy Booking Process</h2>
           ...
           <div className="card bg-blue-200  border-blue-800 border">
              <div className="card-body">
                   <h2 className="card-title font-semibold text-blue-800"><span className="text-2xl"><FcOnlineSupport /></span>Customer Support</h2>
